...
"""
    ...
    def _copy_site_package(self, dep_info):
        ...
        src_base_dir = os.path.join(dep_info.package_folder, "lib")
        if self.settings.os != "Windows":
            src_base_dir = os.path.join(src_base_dir, self._py_dir_name)
        src_base_dir = os.path.join(src_base_dir, "site-packages")
